...
using OwinAuthenticationExample.Models;
using System.Web.Security;
using System.Collections.Generic;

namespace OwinAuthenticationExample.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public enum RolesClaimType { Admin, Client, Other };
        public enum GroupClaimType { Admin, Client, Other };

        [HttpPost]
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> OficialLogin(LoginViewModel model, string returnUrl)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
